/*
  # Fix company invitation and creation functions
  
  1. Changes
     - Fix company invitation function to properly send email
     - Fix company creation to properly set admin role
     - Add RLS policies for company management
*/
...
VALUES (
  ...
  jsonb_build_object(
    ...
    'details', 'Fixed company invitation function to properly handle invitations'
  ),
  'Migration log entry'
